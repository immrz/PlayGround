...
class Config(object):
    ...
    data_path = r'D:\runzemao2\research\stanford-cs224n\assignment2\data'
    train_file = 'train.conll'
    dev_file = 'dev.conll'
    test_file = 'test.conll'
    embedding_file = r"D:\runzemao2\research\stanford-cs224n\assignment2\data\en-cw.txt"
...
def load_and_preprocess_data(reduced=True, data_path=None):
    config = Config()
    if data_path is not None:
        config.data_path = data_path
    config.embedding_file = os.path.join(config.data_path, 'en-cw.txt')
...
if __name__ == '__main__':
    parser, embed_mat, ex, dev, test = load_and_preprocess_data(reduced=True)
